...
_**Note:** National University has since redesigned their website again. Bravery Media had nothing to do with the currently active website._
...
I was left with two options. We could spend another month or two vetting other agencies while also trying to hire for this web developer position, [or Bravery could take on the design portion of the project as well](https://bravery.co/services/).
...
<figure>
    <img
        src="{% src 'nu-home-cover_rdsjk2.jpg' %}"
        srcset="{% srcset 'nu-home-cover_rdsjk2.jpg' %}" alt="National University homepage circa 2018" width="1140" height="1937" loading="lazy" decoding="async"
    />
</figure>
...
Want to do something similar? Or completely different?
